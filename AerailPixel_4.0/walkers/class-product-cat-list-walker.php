<?php
/**
 * Custom_Product_Cat_List_Walker class.
 *
 * @extends 	Walker
...
if ( ! class_exists( 'Custom_Product_Cat_List_Walker' ) ) :

class Custom_Product_Cat_List_Walker extends Walker {
	...
	public function start_el( &$output, $cat, $depth = 0, $args = array(), $current_object_id = 0 ) {
		...
		$output .=  ' <a href="#" class="more-menu up"> </a>';
	}
